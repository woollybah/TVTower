...
Type TTypeId
	...
	Method EnumConstantsList:TList( list:TList=Null )
		If Not list list=New TList
		If _super _super.EnumConstants list
		For Local t:TConstant=EachIn _constsList
			list.AddLast t
		Next
		Return list
	End Method
	...
	Method EnumFieldsList:TList( list:TList=Null )
		If Not list list=New TList
		If _super _super.EnumFields list
		For Local t:TField=EachIn _fieldsList
			list.AddLast t
		Next
		Return list
	End Method
...
'		Next
	...
	Method EnumMethodsList:TList( list:TList=Null )
		Function cmp_by_index:Int( a:TMethod, b:TMethod)
			Return a._index - b._index
		EndFunction
		...
		If Not list list=New TList
		If _super And _super <> Self Then _super.EnumMethods list
		For Local t:TMethod=EachIn _methodsList
			list.AddLast t
		Next
		'FIX: remove overridden methods
'		list.Sort()
...
'		Next
	...
	Method EnumFunctionsList:TList( list:TList=Null )
		Function cmp_by_name:Int( a:TFunction, b:TFunction)
			Return a.Name().Compare(b.Name())
		EndFunction
		...
		If Not list list=New TList
		If _super And _super <> Self Then _super.EnumFunctions list
		For Local t:TFunction=EachIn _functionsList
			list.AddLast t
		Next
